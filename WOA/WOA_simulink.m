...
function [Leader_score,Leader_pos,Convergence_curve]=WOA_simulink(SearchAgents_no,Max_iter,lb,ub,dim,model,var_list,value)
...
while t<Max_iter
    for i=1:size(Positions,1)
        ...
        %% TODO update fitness solver to be output from simulink
        fitness=CostFunction(model, var_list, Positions(i,:));
